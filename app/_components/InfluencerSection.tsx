...
// You'll need to import your image - adjust the path as needed
import influencer from "../../public/assets/influencer.jpg"; // or wherever your image is located

interface InfluencerSectionProps {
  influencerImageSrc?: string; // Make image source configurable
  altText?: string;
}

const InfluencerSection = ({ 
  influencerImageSrc = "/images/influencer.jpg", // Default path - adjust as needed
  altText = "Influencer profile"
  ...
  return (
    <section className="w-full bg-gradient-to-br from-pink-50 to-orange-50 relative overflow-hidden">
      <div className="container mx-auto py-20 px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-pink-200 to-orange-200 rounded-lg blur-xl opacity-0 -z-10"
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div 
          className="absolute bottom-0 right-0 w-32 h-32 bg-primary-200 rounded-full opacity-30"
