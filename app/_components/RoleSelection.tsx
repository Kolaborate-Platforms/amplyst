          ...
          return (
            ...
            >
              ...
              <CardContent>
                ...
                {isSelected && (
                  <Button
                    className={`w-full mt-6 bg-gradient-to-r ${role.gradient} hover:opacity-90 text-white animate-fade-in font-poppins font-medium disabled:opacity-50`}
                    disabled={isLoading}
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    {isLoading ? "Redirecting..." : `Continue as ${role.title}`}
                  </Button>
                )}
              </CardContent>
            </Card>
