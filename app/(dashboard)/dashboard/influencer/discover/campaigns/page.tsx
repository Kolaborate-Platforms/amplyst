...
// Remove the props interface since this is now a page component
const Page = () => {
  ...
  const profile = useQuery(api.users.getMyProfile); // Get current user profile
  ...
  if (!profile || !activeCampaigns || !applications || !allBrands) {
    return (
...
// const Page = ({ campaigns = [] , profile }: CampaignDiscoveryProps) => {
//   const router = useRouter();
//   const [searchTerm, setSearchTerm] = useState("");
//   const [selectedNiche, setSelectedNiche] = useState("all");
//   const [selectedPlatform, setSelectedPlatform] = useState("all");
